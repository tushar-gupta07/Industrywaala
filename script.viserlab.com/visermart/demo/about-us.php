...
<!-- Mirrored from script.viserlab.com/visermart/demo/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jun 2026 16:57:07 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title> Industrywaala - About Us</title>
    <meta name="title" Content="Industrywaala - About Us">
    ...
    <meta name="apple-mobile-web-app-title" content="Visermart - About Us">

    <meta itemprop="name" content="Visermart - About Us">
    ...
    <link rel="stylesheet" href="assets/templates/basic/css/about-us-page.css">
    <style>
    .header-bottom {
...
<body>
    ...
    <main>
        <div class="bg-white">
            <div class="banner"
                style="background-image: url('assets/images/frontend/about_us/6723853527b291730381109.png');">
                <div class="banner__content">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-7 col-lg-6 col-xxl-5">
                                <div class="about-banner">
                                    <h1 class="about-banner__title">We believe we can make everyone stylish.
                                    </h1>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-4 justify-content-between align-items-center">
                        <div class="col-md-5 col-lg-6">
                            <div class="text-center">
                                <img src="assets/images/default.png"
                                    data-src="https://script.viserlab.com/visermart/demo/assets/images/frontend/about_us/672607bcbd2991730545596.png"
                                    alt="image" class="img-fluid lazyload">
                            </div>
                        </div>
                        ...
                        <div class=" col-md-7 col-lg-6 ">
                            <div class="about-description-wrapper">
                                ...
                                <h2 class="section__title mt-2">Pleasant Shopping With Visermart</h2>
                                <div class="description">
                                    <p class="sm-text">Visermart is a web-based commercial center with online business
                                        stores in
                                        USA. Moving. Valentine's Day Sale , Visermart Flash ...You've visited this page
                                        ordinarily.
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <div class="text-center d-none d-md-block">
                                <img src="assets/images/frontend/quote/6723b205530861730392581.png" alt="image"
                                    class="img-fluid testimonial__img" />
                            </div>
                        </div>
                        <div class="col-md-7">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    ...
                                    <g>
                                        <path
                                            ...
                                            fill="hsl(var(--base))" opacity="1" data-original="#000000" class=""></path>
                                    </g>
                                </svg>
                                <p class="testimonial__text">Visermart is a popular shopping platform for you, dolor sit
                                    amet consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                    dolore magna aliquenenatis tellus in. Metus vulputate eu scelerisque felis. </p>

                                <div class="testimonial__footer">
                                    <h2 class="testimonial__title">Esther Howard</h2>
                                    <span class="testimonial__cite"> CEO, Visermart </span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section__head">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center">
                                    <span class="section__subtitle">Features</span>
                                    <h2 class="section__title my-3 text-center justify-content-center">Your Easy Shopping
                                    </h2>
                                    <p class="sm-text text-center mb-0">Make your life easier by purchasing our special
                                        products
                                    </p>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row gy-3 justify-content-center">
                                ...
                                <li>
                                    <div class="feature-card">
                                        <div class="feature-card__head">
                                            ...
                                            <h4 class="feature-card__title">Secure Payment</h4>
                                        </div>
                                        <div class="feature-card__body">
                                            <p class="m-0 sm-text">Secure transactions with trusted payment methods for
                                                worry-free shopping.</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="feature-card">
                                        <div class="feature-card__head">
                                            ...
                                            <h4 class="feature-card__title">Support Center</h4>
                                        </div>
                                        <div class="feature-card__body">
                                            <p class="m-0 sm-text">24/7 support to assist with orders, payments, and
                                                inquiries.</p>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="col-lg-4 order-3 order-lg-2 d-none d-lg-block">
                            <div class="text-center">
                                <img src="assets/images/default.png"
                                    data-src="https://script.viserlab.com/visermart/demo/assets/images/frontend/feature/6723b902c14761730394370.png"
                                    alt="image" class="img-fluid lazyload">
                            </div>
                        </div>
                                ...
                                <li>
                                    <div class="feature-card">
                                        <div class="feature-card__head">
                                            ...
                                            <h4 class="feature-card__title">Product Returns</h4>
                                        </div>
                                        <div class="feature-card__body">
                                            <p class="m-0 sm-text">Hassle-free returns with a simple and quick refund
                                                process.</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="feature-card">
                                        <div class="feature-card__head">
                                            ...
                                            <h4 class="feature-card__title">Fast Delivery</h4>
                                        </div>
                                        <div class="feature-card__body">
                                            <p class="m-0 sm-text">Swift shipping ensures your orders arrive on time,
                                                every time.</p>
                                        </div>
                                    </div>
                                </li>
    ...
    <div class="cookies-card text-center hide">
        ...
        <p class="mt-4 cookies-card__content">We may use cookies or any other tracking technologies when you visit our
            website, including any other media form, mobile website, or mobile application related or connected to help
            customize the Site and improve your experience. <a href="cookie-policy.php" target="_blank"
                class="text--base">Learn More</a></p>
                        ...
                        <form method="POST" action="https://script.viserlab.com/visermart/demo/user/login"
                            ...
                            <p class="create-accounts mb-0 mt-2">
                                <span class="text-dark">
                                    Don't have an account? <a href="user/register.php" class="text--base">Create Account</a>
                                </span>
                            </p>
                        </form>
...
<!-- Mirrored from script.viserlab.com/visermart/demo/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jun 2026 16:57:10 GMT -->
